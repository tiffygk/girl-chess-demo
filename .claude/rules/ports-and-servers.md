...
A merge that changes `server/**` restarts her live server. Before merging such a change, check her live db read only for no move in the last 15 minutes and no open (unfinished) game with a recent move.
